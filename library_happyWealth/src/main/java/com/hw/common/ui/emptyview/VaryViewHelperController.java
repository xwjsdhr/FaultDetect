 ...
 */
package com.hw.common.ui.emptyview;
...
public class VaryViewHelperController {
    ...
    public void showLoading(String msg) {
        View layout = helper.inflate(R.layout.empty_loading);
